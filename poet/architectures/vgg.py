...
def vgg16_patch(batch_size, num_classes=1000, input_shape=(3, 224, 224)):
    def make_conv_stack(in_channels, out_filters, kernel_size, x):
        # Stride=1, padding=(1,1)
        conv = Conv2dPatchedLayer(in_channels, out_filters, kernel_size, 1, (1, 1), (2, 2), x)
        relu = ReLULayer(conv)
        return [conv, relu]
...
def vgg16_fused(batch_size, num_classes=1000, input_shape=(3, 224, 224)):
    def make_conv_stack(in_channels, out_filters, kernel_size, x):
        # Stride=1, padding=(1,1)
        conv_relu = Conv2dReLULayer(in_channels, out_filters, kernel_size, 1, (1, 1), x)
        return [conv_relu]
...
def vgg16_inplace(batch_size, num_classes=1000, input_shape=(3, 224, 224)):
    def make_conv_stack(in_channels, out_filters, kernel_size, x):
        # Stride=1, padding=(1,1)
        conv = InPlaceConv2dLayer(in_channels, out_filters, kernel_size, 1, (1, 1), x)
        relu = ReLULayer(conv)
        return [conv, relu]
...
def vgg16_im2col(batch_size, num_classes=1000, input_shape=(3, 224, 224)):
    def make_conv_stack(in_channels, out_filters, kernel_size, x):
        # Stride=1, padding=(1,1)
        conv = Im2ColConv2dLayer(in_channels, out_filters, kernel_size, 1, (1, 1), x)
        relu = ReLULayer(conv)
        return [conv, relu]
...
def vgg16_cache(batch_size, num_classes=1000, input_shape=(3, 224, 224)):
    def make_conv_stack(in_channels, out_filters, kernel_size, x):
        # Stride=1, padding=(1,1)
        conv = CacheConv2dLayer(in_channels, out_filters, kernel_size, 1, (1, 1), x)
        relu = ReLULayer(conv)
        return [conv, relu]
